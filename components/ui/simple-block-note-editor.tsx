...
function AnimatedGradientText({
  ...
  return (
    <span
      className={`bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-600 bg-clip-text text-transparent animate-gradient ${className}`}
    >
      {children}
    </span>
  );
...
export const SimpleBlockNoteEditor = memo(function SimpleBlockNoteEditor({
  ...
  const [isFormattingDropdownOpen, setIsFormattingDropdownOpen] =
    useState(false);
            ...
            {currentAlignment === "left" && (
              ...
              >
                <g clipPath="url(#clip0_475_1264)">
                  <path
                    d="M9.31982 2H1.06982"
                    stroke="#E6E6E6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M5.65316 4.5H1.06982"
                    stroke="#E6E6E6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M7.48649 7H1.06982"
                    stroke="#E6E6E6"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                ...
                if (selectedText && selectedText.trim()) {
                  ...
                  fetch("/api/tasks", {
                    ...
                    .then((response) => {
                      if (response.ok) {
                        console.log(
                          "Task created successfully from selected text",
                        );
          ...
          >
            ...
            >
              <g clipPath="url(#clip0_479_2074)">
                <path
                  d="M3.94077 8.21509H2.85474C2.13465 8.21509 1.44406 7.92903 0.934879 7.41986C0.425702 6.91068 0.139648 6.22009 0.139648 5.5C0.139648 4.77991 0.425702 4.08932 0.934879 3.58014C1.44406 3.07097 2.13465 2.78491 2.85474 2.78491H3.94077M7.19888 2.78491H8.28491C9.005 2.78491 9.69559 3.07097 10.2048 3.58014C10.7139 4.08932 11 4.77991 11 5.5C11 6.22009 10.7139 6.91068 10.2048 7.41986C9.69559 7.92903 9.005 8.21509 8.28491 8.21509H7.19888M3.39775 5.5H7.74189"
                  stroke="#C4C4C4"
                  strokeWidth="1.08604"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <defs>
                <clipPath id="clip0_479_2074">
                  <rect
                    ...
                    height="9.43018"
                    fill="white"
                    transform="translate(0.0698242 0.784912)"
                  />
                </clipPath>
              </defs>
            </svg>
          ...
          >
            ...
            >
              <g clipPath="url(#clip0_479_2079)">
                <path
                  d="M8.82793 8.67197L11 6.4999L8.82793 4.32783M2.31172 4.32783L0.139648 6.4999L2.31172 8.67197M6.92737 2.15576L4.21228 10.844"
                  stroke="#C4C4C4"
                  strokeWidth="1.08604"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <defs>
                <clipPath id="clip0_479_2079">
                  <rect
                    ...
                    height="12.6883"
                    fill="white"
                    transform="translate(0.0698242 0.155762)"
                  />
                </clipPath>
              </defs>
            </svg>
