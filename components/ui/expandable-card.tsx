      ...
      content: () => {
        return (
          <p>
            ...
            her deep, sultry voice and poetic lyrics. <br /> <br />
            Her music is often characterized by its vintage-inspired aesthetic,
            drawing heavily from Americana and pop culture references from the
            1950s and 1960s. This, combined with her hauntingly beautiful
            melodies, creates a unique sonic landscape that resonates with fans
            across the globe.
          </p>
        )
      },
      ...
      content: () => {
        return (
          <p>
            ...
            His song "Mitran Di Chhatri" is a classic that showcases his ability to
            blend traditional Punjabi folk with modern elements, creating a
      ...
      content: () => {
        return (
          <p>
            ...
            powerful, complex compositions and has significantly influenced the
            genre since their formation in 1981. <br /> <br />
            The song "For Whom the Bell Tolls" was inspired by the novel of the
            same name by Ernest Hemingway. The track, from their 1984 album "Ride
            the Lightning," showcases the band's ability to combine literary
            themes with their signature aggressive sound.
          </p>
        )
      },
    },
