...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex flex-col space-y-1.5 p-[var(--widget-padding)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-[var(--widget-padding)]", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-[var(--widget-padding)] pt-0", className)}
    {...props}
  />
))
